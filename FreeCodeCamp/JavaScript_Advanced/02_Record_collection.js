...
function updateRecords(id, prop, value) {
  if (!value) {
    delete collection[String(id)][prop];
  } else {
    if (prop === "tracks" && collection[String(id)].tracks) {
      collection[String(id)].tracks.push(value);
    } else if (prop === "tracks") {
      collection[String(id)].tracks = [value];
    } else {
      collection[String(id)][prop] = value;
    }
  }
